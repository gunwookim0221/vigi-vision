...
function createHarness(
  ...
  if (options.evidence) {
    [
      ...
      ["#recording-search-end-frame-meta", "dl"],
      ["#recording-search-end-caption", "figcaption"],
  ...
  return {
    ...
    recordingSearchEndTime: elements.get("#recording-search-end-time"),
    recordingSearchEndFrameMeta: elements.get("#recording-search-end-frame-meta"),
    recordingSearchEndCaption: elements.get("#recording-search-end-caption"),
