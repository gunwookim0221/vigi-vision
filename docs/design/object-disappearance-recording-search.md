...
For the production Phase 7E adapter, readiness is checked before media work is
admitted (checkpoint readability and required runtime imports). B4 computation
runs in one bounded, single-use child process created with the platform's
`spawn` start method
...
next attempt can begin, and queued or late output is never accepted. Cold
startup/preparation has its own bounded 30-second budget; the existing
30-second inference budget starts after preprocessing, and safe stage timings
are process-local diagnostics only. A valid result receives a bounded
two-second graceful Windows worker-reap tail before cleanup is classified as
failed; no live child or late result crosses the evidence boundary.
...
```json
[{"family":"policy","domain":"vigi.recording-search.request-relative.policy.v1","expected_id":"rr-policy-v1-85724f1281baed3d092528763890d640dcf6dd303ce8398d1194ffaac6b7560a","payload":{"schema_family":[5,6,7],"provenance_level":"REQUEST_RELATIVE_ESTIMATE","default_search_duration_seconds":300,"maximum_search_duration_seconds":600,"coarse_interval_seconds":300,"support_count":3,"support_cadence_seconds":1,"binary_stop_seconds":1,"maximum_consecutive_indeterminate_targets":3,"maximum_mp4_bytes":4294967296,"maximum_process_memory_bytes":2147483648,"maximum_selected_rgb24_frames":12,"maximum_targets_per_decoder_pass":32,"maximum_decoder_passes":11,"maximum_classifications":32,"replay_margin_seconds":40,"ffprobe_timeout_seconds":20,"decoder_timeout_seconds":120,"classifier_timeout_seconds":30,"classifier_total_budget_seconds":320,"terminal_interpretation_seconds":10,"publication_seconds":10,"strict_readback_seconds":20,"source_clip_timeout_seconds":120,"cleanup_reserve_seconds":60,"invocation_deadline_seconds":2520,"phase8_retry_deadline_seconds":180,"source_clip_pre_seconds":10,"source_clip_post_seconds":30,"maximum_found_interval_seconds":1,"maximum_source_clip_seconds":41,"maximum_source_clip_bytes":536870912,"maximum_source_frame_rate":[60,1]}},{"family":"classifier-policy","domain":"vigi.recording-search.request-relative.classifier-policy.v1","expected_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","payload":{"classifier_family":"efficient-sam-ti-roi-ncc","implementation_version":1,"implementation_source_commit":"d525f622e6f640acf5a0fc37c7ca1f243da5bde0","checkpoint_logical_name":"efficient_sam_vitt.pt","checkpoint_sha256":"dff858b19600a46461cbb7de98f796b23a7a888d9f5e34c0b033f7d6eb9e4e6a","runtime":{"python":"3.11","torch":"2.10.0+cpu","torchvision":"0.25.0+cpu","pillow":"12.3.0","numpy":"2.4.6","device":"cpu","tensor_dtype":"float32","comparison_dtype":"float64"},"input":{"color_space":"RGB","channel_order":"RGB","normalization":"torchvision.to_tensor uint8/255","resize":"none before upstream model preprocessing","interpolation":"upstream commit-owned","positive_point_shape":[1,1,1,2],"point_label_shape":[1,1,1],"positive_point_label":1,"prompt":"confirmed_roi_center_v1"},"mask":{"logit_threshold":"0.000000","candidate_selection":"highest predicted_iou among valid candidates","must_contain_prompt":true,"minimum_width":4,"minimum_height":4,"minimum_pixel_count":64,"maximum_source_coverage":"0.950000","alignment":"source_pixel_grid"},"comparison":{"roi_preprocessing":"phase7b-roi-luma-v1","luma_coefficients":[299,587,114],"luma_divisor":1000,"luma_rounding":"add_500_then_floor","ncc_area":"mask_intersection","minimum_overlap_fraction":"0.100000","minimum_effective_area_pixels":64,"metric_rounding":"half_even","decimal_places":6},"decision":{"present_min_iou":"0.500000","present_min_ncc":"0.600000","absent_max_iou":"0.100000","absent_max_ncc":"0.200000","otherwise":"INDETERMINATE"},"execution":{"timeout_seconds":30,"maximum_attempts":1,"maximum_concurrent_attempts":1,"late_result":"revoked","timeout_result":"OPERATIONAL","unknown_result":"OPERATIONAL_INVALID","retry":"new_run_only"}}},{"family":"media-generation-policy","domain":"vigi.recording-search.request-relative.media-generation-policy.v1","expected_id":"rr-media-policy-v1-8d7800b18530b39d9f317015504a1cdfb5d8770c0427221fc0a00093070dd3d1","payload":{"container":"mp4","stream_copy":{"eligible":true,"requires_single_video":true,"requires_no_audio":true,"requires_same_codec_parameters":true,"requires_interval_bounds":true,"requires_metadata_allowlist":true},"reencode":{"codec":"h264","encoder":"libx264","profile":"High","level":"4.1","pixel_format":"yuv420p","preset":"medium","crf":23,"frame_rate_source":"selected_stream_avg_frame_rate","vfr_mode":"passthrough","faststart":true},"audio":"drop","chapters":"drop","copied_metadata":"drop","interval_tolerance":"one_source_frame","maximum_frame_rate":[60,1],"maximum_duration_seconds":41,"maximum_size_bytes":536870912,"timeout_seconds":120}},{"family":"coarse-plan","domain":"vigi.recording-search.request-relative.coarse-plan.v1","expected_id":"rr-coarse-plan-v1-23b94ff5f50410add7603679ae0c5583f4375661204404d9a403d90d7cf22bc4","payload":{"investigation_id":"inv-01","run_id":"run-01","channel_id":1,"policy_id":"rr-policy-v1-85724f1281baed3d092528763890d640dcf6dd303ce8398d1194ffaac6b7560a","start_requested_time_utc":"2026-07-20T03:00:00Z","end_requested_time_utc":"2026-07-20T03:00:04Z","target_requested_times_utc":["2026-07-20T03:00:00Z","2026-07-20T03:00:04Z"]}},{"family":"replay-operation","domain":"vigi.recording-search.request-relative.replay-operation.v1","expected_id":"rr-replay-operation-v1-e4ebcd655d3a6744fe274fef259d13cc761a547c74f653cdaf4fef18711d65e2","payload":{"investigation_id":"inv-01","run_id":"run-01","policy_id":"rr-policy-v1-85724f1281baed3d092528763890d640dcf6dd303ce8398d1194ffaac6b7560a","plan_id":"rr-coarse-plan-v1-23b94ff5f50410add7603679ae0c5583f4375661204404d9a403d90d7cf22bc4","channel_id":1,"segment_id":"sdk-segment-01","replay_start_requested_time_utc":"2026-07-20T03:00:00Z","replay_end_requested_time_utc":"2026-07-20T03:00:04Z"}},{"family":"target-request","domain":"vigi.recording-search.request-relative.target-request.v1","expected_id":"rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e","payload":{"investigation_id":"inv-01","run_id":"run-01","plan_id":"rr-coarse-plan-v1-23b94ff5f50410add7603679ae0c5583f4375661204404d9a403d90d7cf22bc4","sequence":1,"kind":"COARSE","requested_time_utc":"2026-07-20T03:00:04Z","selection_rule":"FINAL_STRICTLY_BEFORE_END"}},{"family":"schema5-manifest","domain":"vigi.recording-search.request-relative.schema5-manifest.v1","expected_id":"rr-schema5-manifest-v1-ffaf6d24c28c6eda8898815901b8d12d1d5756276a3f0e223ea5aa043671a712","payload":{"schema_version":5,"investigation_id":"inv-01","run_id":"run-01","policy_id":"rr-policy-v1-85724f1281baed3d092528763890d640dcf6dd303ce8398d1194ffaac6b7560a","plan_id":"rr-coarse-plan-v1-23b94ff5f50410add7603679ae0c5583f4375661204404d9a403d90d7cf22bc4","coarse_target_request_ids":["rr-target-request-v1-f5086a246443b925a8e316f94ff4ebdf51f5938d067da97c0bf98d9c8d753e0d","rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e"]}},{"family":"common-session","domain":"vigi.recording-search.request-relative.common-session.v1","expected_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","payload":{"investigation_id":"inv-01","run_id":"run-01","replay_operation_id":"rr-replay-operation-v1-e4ebcd655d3a6744fe274fef259d13cc761a547c74f653cdaf4fef18711d65e2","policy_id":"rr-policy-v1-85724f1281baed3d092528763890d640dcf6dd303ce8398d1194ffaac6b7560a","segment_id":"sdk-segment-01","replay_start_requested_time_utc":"2026-07-20T03:00:00Z","replay_end_requested_time_utc":"2026-07-20T03:00:04Z","selected_video_stream_index":0,"container_start_pts":0,"time_base_num":1,"time_base_den":16384,"duration_ticks":65536,"mp4_size_bytes":2430,"mp4_sha256":"9e23896ae9d7d66b3473be0da74cf92f51752af0d1a7873f5921a7a4f712ceb3","provenance_level":"REQUEST_RELATIVE_ESTIMATE","physical_time_bias":"UNKNOWN_UNBOUNDED"}},{"family":"decoder-operation","domain":"vigi.recording-search.request-relative.decoder-operation.v1","expected_id":"rr-decoder-operation-v1-479f56f2c438cdbd0603b8280095fc56ca1b8a881496941b7e6b653b18c0ce55","payload":{"investigation_id":"inv-01","run_id":"run-01","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","pass_number":1,"target_request_ids":["rr-target-request-v1-f5086a246443b925a8e316f94ff4ebdf51f5938d067da97c0bf98d9c8d753e0d","rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e","rr-target-request-v1-b501e0aa7edbe22730d48dbfd1f15106373ef1ea74bd90cbf99cf491156fbfd1","rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","rr-target-request-v1-79061c6d9b7cf204a9679ae1a91a9b08320ae5b324197b9645bf4048207a1a4c"]}},{"family":"frame","domain":"vigi.recording-search.request-relative.frame.v1","expected_id":"rr-frame-v1-ae14b92f4902f0d9ea6f91f954070c99b6a190015d80f0e2a70fea0e0ec2e3b3","payload":{"investigation_id":"inv-01","run_id":"run-01","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","decoder_operation_id":"rr-decoder-operation-v1-479f56f2c438cdbd0603b8280095fc56ca1b8a881496941b7e6b653b18c0ce55","selected_video_stream_index":0,"target_request_id":"rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e","raw_pts":49152,"container_start_pts":0,"time_base_num":1,"time_base_den":16384,"estimated_requested_time_utc":"2026-07-20T03:00:03Z","ordinal":3,"width":32,"height":32,"jpeg_size_bytes":657,"jpeg_sha256":"632b544f4ff8b66549bb1922d91c7c5b9000aeeddd4ecf61ebc2f630b49ee008","rgb24_sha256":"4f6bf378a3934fe2ea630778bb0fbfc537586986588215ca0adb0855b8b2e3ae"}},{"family":"classification-operation","domain":"vigi.recording-search.request-relative.classification-operation.v1","expected_id":"rr-classification-operation-v1-dd4a8993506274e654de259612907db2bc02e1246972873e20babeb618a3d549","payload":{"investigation_id":"inv-01","run_id":"run-01","frame_id":"rr-frame-v1-ae14b92f4902f0d9ea6f91f954070c99b6a190015d80f0e2a70fea0e0ec2e3b3","target_request_id":"rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e","baseline_identity":"baseline-v3-01","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","attempt":1,"result_kind":"VISUAL","outcome":"ABSENT","reason_code":null,"classifier_evidence":{"baseline_mask_pixel_count":640,"probe_mask_pixel_count":64,"roi_pixel_count":1024,"mask_intersection_pixel_count":64,"mask_union_pixel_count":640,"baseline_mask_coverage":"0.625000","probe_mask_coverage":"0.062500","mask_iou":"0.100000","effective_comparison_area":64,"roi_luma_ncc":"0.200000","visual_status":"comparable","unusable_reason":null},"operational_reason":null}},{"family":"observation","domain":"vigi.recording-search.request-relative.observation.v1","expected_id":"rr-observation-v1-245ba4cdad4702fb8d077a664db66ab5cee6b57e48d518ff0e446c04240cdba8","payload":{"investigation_id":"inv-01","run_id":"run-01","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","classification_operation_id":"rr-classification-operation-v1-dd4a8993506274e654de259612907db2bc02e1246972873e20babeb618a3d549","frame_id":"rr-frame-v1-ae14b92f4902f0d9ea6f91f954070c99b6a190015d80f0e2a70fea0e0ec2e3b3","target_request_id":"rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","outcome":"ABSENT","reason_code":null,"classifier_evidence":{"baseline_mask_pixel_count":640,"probe_mask_pixel_count":64,"roi_pixel_count":1024,"mask_intersection_pixel_count":64,"mask_union_pixel_count":640,"baseline_mask_coverage":"0.625000","probe_mask_coverage":"0.062500","mask_iou":"0.100000","effective_comparison_area":64,"roi_luma_ncc":"0.200000","visual_status":"comparable","unusable_reason":null}}},{"family":"alias","domain":"vigi.recording-search.request-relative.alias.v1","expected_id":"rr-alias-v1-4b7ae557e80940c4a9346a6f716c24a2d7835e809c281cdbacdcd8b130033fab","payload":{"investigation_id":"inv-01","run_id":"run-01","target_request_id":"rr-target-request-v1-79061c6d9b7cf204a9679ae1a91a9b08320ae5b324197b9645bf4048207a1a4c","frame_id":"rr-frame-v1-ae14b92f4902f0d9ea6f91f954070c99b6a190015d80f0e2a70fea0e0ec2e3b3","alias_of_target_request_id":"rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e"}},{"family":"support-group","domain":"vigi.recording-search.request-relative.support-group.v1","expected_id":"rr-support-group-v1-c2af9c364046d092281af5f919a0c311247ad066a6aa209cd740673f8f71a62c","payload":{"investigation_id":"inv-01","run_id":"run-01","origin_target_request_id":"rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e","member_target_request_ids":["rr-target-request-v1-b501e0aa7edbe22730d48dbfd1f15106373ef1ea74bd90cbf99cf491156fbfd1","rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","rr-target-request-v1-79061c6d9b7cf204a9679ae1a91a9b08320ae5b324197b9645bf4048207a1a4c"],"member_frame_ids":["rr-frame-v1-d7ce40102428c857bff432fca759fad369ef8d8b01cfbb3db3135a432362b160","rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","rr-frame-v1-ae14b92f4902f0d9ea6f91f954070c99b6a190015d80f0e2a70fea0e0ec2e3b3"],"member_observation_ids":["rr-observation-v1-63a3d24c0565cc60b5796591a5c8462d9789258dd5027310acf2b85ac0671739","rr-observation-v1-dc4c6b50adf0d8099becbb5ec2d32abaffe4f14e9d6b499b607c3b73134e5a33","rr-observation-v1-245ba4cdad4702fb8d077a664db66ab5cee6b57e48d518ff0e446c04240cdba8"],"outcome":"SUPPORTED_ABSENT"}},{"family":"c2-bracket","domain":"vigi.recording-search.request-relative.c2-bracket.v1","expected_id":"rr-c2-bracket-v1-edcd09fb4fcf5fe7025655f59e78b1f59e3d1e6e2c20d0147e421c913f30f5ce","payload":{"investigation_id":"inv-01","run_id":"run-01","lower_observation_id":"rr-observation-v1-0d6159114041864969162f08952cc1bb8254bcdccf01f71cea76927c52218c5f","upper_observation_id":"rr-observation-v1-245ba4cdad4702fb8d077a664db66ab5cee6b57e48d518ff0e446c04240cdba8","upper_support_group_id":"rr-support-group-v1-c2af9c364046d092281af5f919a0c311247ad066a6aa209cd740673f8f71a62c","status":"BRACKET_READY"}},{"family":"d1-input","domain":"vigi.recording-search.request-relative.d1-input.v1","expected_id":"rr-d1-input-v1-f7c9081e6a83b5da77c4aca16f0dd66bc7313d5e0f46819adb8fb3bc6eafd37e","payload":{"investigation_id":"inv-01","run_id":"run-01","c2_bracket_id":"rr-c2-bracket-v1-edcd09fb4fcf5fe7025655f59e78b1f59e3d1e6e2c20d0147e421c913f30f5ce","policy_id":"rr-policy-v1-85724f1281baed3d092528763890d640dcf6dd303ce8398d1194ffaac6b7560a"}},{"family":"d1-history","domain":"vigi.recording-search.request-relative.d1-history.v1","expected_id":"rr-d1-history-v1-99c4e6f024437ba36d451828c5afafd9364c2cf1fcffb6888264287ceb09cdd0","payload":{"investigation_id":"inv-01","run_id":"run-01","d1_input_id":"rr-d1-input-v1-f7c9081e6a83b5da77c4aca16f0dd66bc7313d5e0f46819adb8fb3bc6eafd37e","steps":[]}},{"family":"narrowed-bracket","domain":"vigi.recording-search.request-relative.narrowed-bracket.v1","expected_id":"rr-narrowed-bracket-v1-aa0f9877ecbe06d083f4c525b05c5fdf3d483234500c6717bfe1ad61ef37279f","payload":{"investigation_id":"inv-01","run_id":"run-01","d1_input_id":"rr-d1-input-v1-f7c9081e6a83b5da77c4aca16f0dd66bc7313d5e0f46819adb8fb3bc6eafd37e","d1_history_id":"rr-d1-history-v1-99c4e6f024437ba36d451828c5afafd9364c2cf1fcffb6888264287ceb09cdd0","lower_observation_id":"rr-observation-v1-0d6159114041864969162f08952cc1bb8254bcdccf01f71cea76927c52218c5f","upper_observation_id":"rr-observation-v1-245ba4cdad4702fb8d077a664db66ab5cee6b57e48d518ff0e446c04240cdba8","upper_support_group_id":"rr-support-group-v1-c2af9c364046d092281af5f919a0c311247ad066a6aa209cd740673f8f71a62c","interval_start_requested_time_utc":"2026-07-20T03:00:00Z","interval_end_requested_time_utc":"2026-07-20T03:00:01Z","stop_reason":"TARGET_PRECISION_REACHED"}},{"family":"schema6-manifest","domain":"vigi.recording-search.request-relative.schema6-manifest.v1","expected_id":"rr-schema6-manifest-v1-1865ece8760cd20192e94df3a4326a6f50d9d3c5b9cd20f516bfa55557764350","payload":{"schema_version":6,"investigation_id":"inv-01","run_id":"run-01","schema5_predecessor_manifest_id":"rr-schema5-manifest-v1-ffaf6d24c28c6eda8898815901b8d12d1d5756276a3f0e223ea5aa043671a712","policy_id":"rr-policy-v1-85724f1281baed3d092528763890d640dcf6dd303ce8398d1194ffaac6b7560a","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","plan_id":"rr-coarse-plan-v1-23b94ff5f50410add7603679ae0c5583f4375661204404d9a403d90d7cf22bc4","replay_operation_id":"rr-replay-operation-v1-e4ebcd655d3a6744fe274fef259d13cc761a547c74f653cdaf4fef18711d65e2","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","indexes":{"target_request_ids":["rr-target-request-v1-f5086a246443b925a8e316f94ff4ebdf51f5938d067da97c0bf98d9c8d753e0d","rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e","rr-target-request-v1-b501e0aa7edbe22730d48dbfd1f15106373ef1ea74bd90cbf99cf491156fbfd1","rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","rr-target-request-v1-79061c6d9b7cf204a9679ae1a91a9b08320ae5b324197b9645bf4048207a1a4c"],"decoder_operation_ids":["rr-decoder-operation-v1-479f56f2c438cdbd0603b8280095fc56ca1b8a881496941b7e6b653b18c0ce55"],"frame_ids":["rr-frame-v1-49b75b91470d3a5e92a8e258c8743a6efa5b119ec8d9fec5dea3f3faae7a53fa","rr-frame-v1-d7ce40102428c857bff432fca759fad369ef8d8b01cfbb3db3135a432362b160","rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","rr-frame-v1-ae14b92f4902f0d9ea6f91f954070c99b6a190015d80f0e2a70fea0e0ec2e3b3"],"classification_operation_ids":["rr-classification-operation-v1-084fca60c1c68f60ec42c584fb9cdc5222e06a599671bf6cf3c249b74a68d778","rr-classification-operation-v1-c0911e3562c26ffee11d8c02359316eb267f8c17439e67c04f32c727e06ef609","rr-classification-operation-v1-252a542e91d1effa800a913b311f0a8bf01294df5050aa2e93a8f3067bda4d69","rr-classification-operation-v1-dd4a8993506274e654de259612907db2bc02e1246972873e20babeb618a3d549"],"observation_ids":["rr-observation-v1-0d6159114041864969162f08952cc1bb8254bcdccf01f71cea76927c52218c5f","rr-observation-v1-63a3d24c0565cc60b5796591a5c8462d9789258dd5027310acf2b85ac0671739","rr-observation-v1-dc4c6b50adf0d8099becbb5ec2d32abaffe4f14e9d6b499b607c3b73134e5a33","rr-observation-v1-245ba4cdad4702fb8d077a664db66ab5cee6b57e48d518ff0e446c04240cdba8"],"alias_ids":["rr-alias-v1-4b7ae557e80940c4a9346a6f716c24a2d7835e809c281cdbacdcd8b130033fab"],"support_group_ids":["rr-support-group-v1-c2af9c364046d092281af5f919a0c311247ad066a6aa209cd740673f8f71a62c"],"c2_bracket_ids":["rr-c2-bracket-v1-edcd09fb4fcf5fe7025655f59e78b1f59e3d1e6e2c20d0147e421c913f30f5ce"],"d1_input_ids":["rr-d1-input-v1-f7c9081e6a83b5da77c4aca16f0dd66bc7313d5e0f46819adb8fb3bc6eafd37e"],"d1_history_ids":["rr-d1-history-v1-99c4e6f024437ba36d451828c5afafd9364c2cf1fcffb6888264287ceb09cdd0"],"narrowed_bracket_ids":["rr-narrowed-bracket-v1-aa0f9877ecbe06d083f4c525b05c5fdf3d483234500c6717bfe1ad61ef37279f"]}}},{"family":"source-record-set","domain":"vigi.recording-search.request-relative.source-record-set.v1","expected_id":"rr-source-record-set-v1-d48d4f2e56e693abb084f8a63144f30d8d70bfb8b1b944501dc0cf3080300fbc","payload":{"schema_version":1,"investigation_id":"inv-01","run_id":"run-01","schema6_manifest_id":"rr-schema6-manifest-v1-1865ece8760cd20192e94df3a4326a6f50d9d3c5b9cd20f516bfa55557764350","record_groups":[{"type":"policy","ids":["rr-policy-v1-85724f1281baed3d092528763890d640dcf6dd303ce8398d1194ffaac6b7560a"]},{"type":"classifier_policy","ids":["rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f"]},{"type":"schema5_manifest","ids":["rr-schema5-manifest-v1-ffaf6d24c28c6eda8898815901b8d12d1d5756276a3f0e223ea5aa043671a712"]},{"type":"coarse_plan","ids":["rr-coarse-plan-v1-23b94ff5f50410add7603679ae0c5583f4375661204404d9a403d90d7cf22bc4"]},{"type":"replay_operation","ids":["rr-replay-operation-v1-e4ebcd655d3a6744fe274fef259d13cc761a547c74f653cdaf4fef18711d65e2"]},{"type":"common_session","ids":["rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9"]},{"type":"target_requests","ids":["rr-target-request-v1-f5086a246443b925a8e316f94ff4ebdf51f5938d067da97c0bf98d9c8d753e0d","rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e","rr-target-request-v1-b501e0aa7edbe22730d48dbfd1f15106373ef1ea74bd90cbf99cf491156fbfd1","rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","rr-target-request-v1-79061c6d9b7cf204a9679ae1a91a9b08320ae5b324197b9645bf4048207a1a4c"]},{"type":"decoder_operations","ids":["rr-decoder-operation-v1-479f56f2c438cdbd0603b8280095fc56ca1b8a881496941b7e6b653b18c0ce55"]},{"type":"frames","ids":["rr-frame-v1-49b75b91470d3a5e92a8e258c8743a6efa5b119ec8d9fec5dea3f3faae7a53fa","rr-frame-v1-d7ce40102428c857bff432fca759fad369ef8d8b01cfbb3db3135a432362b160","rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","rr-frame-v1-ae14b92f4902f0d9ea6f91f954070c99b6a190015d80f0e2a70fea0e0ec2e3b3"]},{"type":"classification_operations","ids":["rr-classification-operation-v1-084fca60c1c68f60ec42c584fb9cdc5222e06a599671bf6cf3c249b74a68d778","rr-classification-operation-v1-c0911e3562c26ffee11d8c02359316eb267f8c17439e67c04f32c727e06ef609","rr-classification-operation-v1-252a542e91d1effa800a913b311f0a8bf01294df5050aa2e93a8f3067bda4d69","rr-classification-operation-v1-dd4a8993506274e654de259612907db2bc02e1246972873e20babeb618a3d549"]},{"type":"observations","ids":["rr-observation-v1-0d6159114041864969162f08952cc1bb8254bcdccf01f71cea76927c52218c5f","rr-observation-v1-63a3d24c0565cc60b5796591a5c8462d9789258dd5027310acf2b85ac0671739","rr-observation-v1-dc4c6b50adf0d8099becbb5ec2d32abaffe4f14e9d6b499b607c3b73134e5a33","rr-observation-v1-245ba4cdad4702fb8d077a664db66ab5cee6b57e48d518ff0e446c04240cdba8"]},{"type":"aliases","ids":["rr-alias-v1-4b7ae557e80940c4a9346a6f716c24a2d7835e809c281cdbacdcd8b130033fab"]},{"type":"support_groups","ids":["rr-support-group-v1-c2af9c364046d092281af5f919a0c311247ad066a6aa209cd740673f8f71a62c"]},{"type":"c2_brackets","ids":["rr-c2-bracket-v1-edcd09fb4fcf5fe7025655f59e78b1f59e3d1e6e2c20d0147e421c913f30f5ce"]},{"type":"d1_inputs","ids":["rr-d1-input-v1-f7c9081e6a83b5da77c4aca16f0dd66bc7313d5e0f46819adb8fb3bc6eafd37e"]},{"type":"d1_histories","ids":["rr-d1-history-v1-99c4e6f024437ba36d451828c5afafd9364c2cf1fcffb6888264287ceb09cdd0"]},{"type":"narrowed_brackets","ids":["rr-narrowed-bracket-v1-aa0f9877ecbe06d083f4c525b05c5fdf3d483234500c6717bfe1ad61ef37279f"]}],"record_count":30}},{"family":"evidence-snapshot","domain":"vigi.recording-search.request-relative.evidence-snapshot.v1","expected_id":"rr-evidence-snapshot-v1-193394ce84fbdeaeae5cbee9e7202f4e191b2145148290d897115756b826cd40","payload":{"schema_version":1,"investigation_id":"inv-01","run_id":"run-01","source_record_set_id":"rr-source-record-set-v1-d48d4f2e56e693abb084f8a63144f30d8d70bfb8b1b944501dc0cf3080300fbc","policy_id":"rr-policy-v1-85724f1281baed3d092528763890d640dcf6dd303ce8398d1194ffaac6b7560a","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","selected_observation_ids":["rr-observation-v1-0d6159114041864969162f08952cc1bb8254bcdccf01f71cea76927c52218c5f","rr-observation-v1-245ba4cdad4702fb8d077a664db66ab5cee6b57e48d518ff0e446c04240cdba8"],"selected_support_group_ids":["rr-support-group-v1-c2af9c364046d092281af5f919a0c311247ad066a6aa209cd740673f8f71a62c"],"narrowed_bracket_id":"rr-narrowed-bracket-v1-aa0f9877ecbe06d083f4c525b05c5fdf3d483234500c6717bfe1ad61ef37279f"}},{"family":"terminal-result","domain":"vigi.recording-search.request-relative.terminal-result.v1","expected_id":"rr-terminal-result-v1-5e60d22bb0917bc5303962cf5d80c12deffd7adc3e37e50e9edc95adef921cff","payload":{"schema_version":1,"investigation_id":"inv-01","run_id":"run-01","source_record_set_id":"rr-source-record-set-v1-d48d4f2e56e693abb084f8a63144f30d8d70bfb8b1b944501dc0cf3080300fbc","evidence_snapshot_id":"rr-evidence-snapshot-v1-193394ce84fbdeaeae5cbee9e7202f4e191b2145148290d897115756b826cd40","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","result_kind":"FOUND","reason_code":"SUPPORTED_TRANSITION","interval_start_requested_time_utc":"2026-07-20T03:00:00Z","interval_end_requested_time_utc":"2026-07-20T03:00:01Z"}},{"family":"schema7-manifest","domain":"vigi.recording-search.request-relative.schema7-manifest.v1","expected_id":"rr-schema7-manifest-v1-797211e54ab1355f6d95cab67735ce701c4ade22c78631317159524b9436252c","payload":{"schema_version":7,"investigation_id":"inv-01","run_id":"run-01","schema6_predecessor_manifest_id":"rr-schema6-manifest-v1-1865ece8760cd20192e94df3a4326a6f50d9d3c5b9cd20f516bfa55557764350","source_record_set_id":"rr-source-record-set-v1-d48d4f2e56e693abb084f8a63144f30d8d70bfb8b1b944501dc0cf3080300fbc","evidence_snapshot_id":"rr-evidence-snapshot-v1-193394ce84fbdeaeae5cbee9e7202f4e191b2145148290d897115756b826cd40","terminal_result_id":"rr-terminal-result-v1-5e60d22bb0917bc5303962cf5d80c12deffd7adc3e37e50e9edc95adef921cff"}},{"family":"source-clip","domain":"vigi.recording-search.request-relative.source-clip.v1","expected_id":"rr-source-clip-v1-2334094f9d46b889e8b826d668659456d57c028feca87e58cf1e91a0388de503","payload":{"schema_version":1,"investigation_id":"inv-01","run_id":"run-01","terminal_result_id":"rr-terminal-result-v1-5e60d22bb0917bc5303962cf5d80c12deffd7adc3e37e50e9edc95adef921cff","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","media_generation_policy_id":"rr-media-policy-v1-8d7800b18530b39d9f317015504a1cdfb5d8770c0427221fc0a00093070dd3d1","requested_interval_start_requested_time_utc":"2026-07-20T02:59:50Z","requested_interval_end_requested_time_utc":"2026-07-20T03:00:31Z","clipped_interval_start_requested_time_utc":"2026-07-20T03:00:00Z","clipped_interval_end_requested_time_utc":"2026-07-20T03:00:04Z","input_stream_index":0}},{"family":"phase8-request","domain":"vigi.recording-search.request-relative.phase8-request.v1","expected_id":"rr-phase8-request-v1-41e93ebd33d7a546dad57f180f9467977b6345b143b343e32b3f76fee37366f9","payload":{"schema_version":1,"investigation_id":"inv-01","run_id":"run-01","terminal_result_id":"rr-terminal-result-v1-5e60d22bb0917bc5303962cf5d80c12deffd7adc3e37e50e9edc95adef921cff","source_clip_id":"rr-source-clip-v1-2334094f9d46b889e8b826d668659456d57c028feca87e58cf1e91a0388de503","clip_integrity":{"sha256":"9e23896ae9d7d66b3473be0da74cf92f51752af0d1a7873f5921a7a4f712ceb3","size_bytes":2430,"observed_duration_ticks":65536,"observed_time_base_num":1,"observed_time_base_den":16384,"video_stream_index":0,"codec":"h264","profile":"High","level":41,"pixel_format":"yuv420p","width":32,"height":32,"average_frame_rate_num":1,"average_frame_rate_den":1,"audio_stream_count":0,"generation_outcome":"REENCODED"},"selected_observation_ids":["rr-observation-v1-0d6159114041864969162f08952cc1bb8254bcdccf01f71cea76927c52218c5f","rr-observation-v1-245ba4cdad4702fb8d077a664db66ab5cee6b57e48d518ff0e446c04240cdba8"],"selected_support_group_ids":["rr-support-group-v1-c2af9c364046d092281af5f919a0c311247ad066a6aa209cd740673f8f71a62c"]}},{"family":"phase8-manifest","domain":"vigi.recording-search.request-relative.phase8-manifest.v1","expected_id":"rr-phase8-manifest-v1-a2448760860a38d3873fa63ab3cd302b79741a878698bba875ef31c0c94e63da","payload":{"schema_version":1,"state":"READY","investigation_id":"inv-01","run_id":"run-01","terminal_result_id":"rr-terminal-result-v1-5e60d22bb0917bc5303962cf5d80c12deffd7adc3e37e50e9edc95adef921cff","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","previous_phase8_manifest_id":"rr-phase8-manifest-v1-2130eef454647893f9203ded38e56058b6e81c60a7846ed1c33ba8e7dce2b66f","source_clip_id":"rr-source-clip-v1-2334094f9d46b889e8b826d668659456d57c028feca87e58cf1e91a0388de503","clip_integrity":{"sha256":"9e23896ae9d7d66b3473be0da74cf92f51752af0d1a7873f5921a7a4f712ceb3","size_bytes":2430,"observed_duration_ticks":65536,"observed_time_base_num":1,"observed_time_base_den":16384,"video_stream_index":0,"codec":"h264","profile":"High","level":41,"pixel_format":"yuv420p","width":32,"height":32,"average_frame_rate_num":1,"average_frame_rate_den":1,"audio_stream_count":0,"generation_outcome":"REENCODED"},"phase8_request_id":"rr-phase8-request-v1-41e93ebd33d7a546dad57f180f9467977b6345b143b343e32b3f76fee37366f9"}}]
```
...
```json
[{"family":"target-request","domain":"vigi.recording-search.request-relative.target-request.v1","expected_id":"rr-target-request-v1-f5086a246443b925a8e316f94ff4ebdf51f5938d067da97c0bf98d9c8d753e0d","payload":{"investigation_id":"inv-01","run_id":"run-01","plan_id":"rr-coarse-plan-v1-23b94ff5f50410add7603679ae0c5583f4375661204404d9a403d90d7cf22bc4","sequence":0,"kind":"COARSE","requested_time_utc":"2026-07-20T03:00:00Z","selection_rule":"NEAREST_IN_HALF_OPEN_SESSION"}},{"family":"target-request","domain":"vigi.recording-search.request-relative.target-request.v1","expected_id":"rr-target-request-v1-b501e0aa7edbe22730d48dbfd1f15106373ef1ea74bd90cbf99cf491156fbfd1","payload":{"investigation_id":"inv-01","run_id":"run-01","plan_id":"rr-coarse-plan-v1-23b94ff5f50410add7603679ae0c5583f4375661204404d9a403d90d7cf22bc4","sequence":2,"kind":"SUPPORT","requested_time_utc":"2026-07-20T03:00:01Z","selection_rule":"NEAREST_IN_HALF_OPEN_SESSION","origin_target_request_id":"rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e"}},{"family":"target-request","domain":"vigi.recording-search.request-relative.target-request.v1","expected_id":"rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","payload":{"investigation_id":"inv-01","run_id":"run-01","plan_id":"rr-coarse-plan-v1-23b94ff5f50410add7603679ae0c5583f4375661204404d9a403d90d7cf22bc4","sequence":3,"kind":"SUPPORT","requested_time_utc":"2026-07-20T03:00:02Z","selection_rule":"NEAREST_IN_HALF_OPEN_SESSION","origin_target_request_id":"rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e"}},{"family":"target-request","domain":"vigi.recording-search.request-relative.target-request.v1","expected_id":"rr-target-request-v1-79061c6d9b7cf204a9679ae1a91a9b08320ae5b324197b9645bf4048207a1a4c","payload":{"investigation_id":"inv-01","run_id":"run-01","plan_id":"rr-coarse-plan-v1-23b94ff5f50410add7603679ae0c5583f4375661204404d9a403d90d7cf22bc4","sequence":4,"kind":"SUPPORT","requested_time_utc":"2026-07-20T03:00:03Z","selection_rule":"NEAREST_IN_HALF_OPEN_SESSION","origin_target_request_id":"rr-target-request-v1-c6eaeb7cc09691e5cbec63c7de8a0e703ff710f43d30a2e6bd292fa28737197e"}},{"family":"frame","domain":"vigi.recording-search.request-relative.frame.v1","expected_id":"rr-frame-v1-49b75b91470d3a5e92a8e258c8743a6efa5b119ec8d9fec5dea3f3faae7a53fa","payload":{"investigation_id":"inv-01","run_id":"run-01","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","decoder_operation_id":"rr-decoder-operation-v1-479f56f2c438cdbd0603b8280095fc56ca1b8a881496941b7e6b653b18c0ce55","selected_video_stream_index":0,"target_request_id":"rr-target-request-v1-f5086a246443b925a8e316f94ff4ebdf51f5938d067da97c0bf98d9c8d753e0d","raw_pts":0,"container_start_pts":0,"time_base_num":1,"time_base_den":16384,"estimated_requested_time_utc":"2026-07-20T03:00:00Z","ordinal":0,"width":32,"height":32,"jpeg_size_bytes":657,"jpeg_sha256":"c5330de6f4fd14cf995a8583581a65df3d8c1f739caf3ec6c1312b6e27fd053c","rgb24_sha256":"22218ffebb43cce5be7c991d4d2976a8645b45c67d6579383ae1704c4b6a56e7"}},{"family":"frame","domain":"vigi.recording-search.request-relative.frame.v1","expected_id":"rr-frame-v1-d7ce40102428c857bff432fca759fad369ef8d8b01cfbb3db3135a432362b160","payload":{"investigation_id":"inv-01","run_id":"run-01","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","decoder_operation_id":"rr-decoder-operation-v1-479f56f2c438cdbd0603b8280095fc56ca1b8a881496941b7e6b653b18c0ce55","selected_video_stream_index":0,"target_request_id":"rr-target-request-v1-b501e0aa7edbe22730d48dbfd1f15106373ef1ea74bd90cbf99cf491156fbfd1","raw_pts":16384,"container_start_pts":0,"time_base_num":1,"time_base_den":16384,"estimated_requested_time_utc":"2026-07-20T03:00:01Z","ordinal":1,"width":32,"height":32,"jpeg_size_bytes":657,"jpeg_sha256":"581b3bd0d4c41c510c994a5f2f9985b3b4d0f2129543b1d921e04f9a62b43c5d","rgb24_sha256":"2b8ac5dd3528ec15ed329b9dbd4e57d3813cfe4917752e2da3552a85bce1643c"}},{"family":"frame","domain":"vigi.recording-search.request-relative.frame.v1","expected_id":"rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","payload":{"investigation_id":"inv-01","run_id":"run-01","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","decoder_operation_id":"rr-decoder-operation-v1-479f56f2c438cdbd0603b8280095fc56ca1b8a881496941b7e6b653b18c0ce55","selected_video_stream_index":0,"target_request_id":"rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","raw_pts":32768,"container_start_pts":0,"time_base_num":1,"time_base_den":16384,"estimated_requested_time_utc":"2026-07-20T03:00:02Z","ordinal":2,"width":32,"height":32,"jpeg_size_bytes":656,"jpeg_sha256":"86ee3bbcaa921459400c534a07284f7f8ab12d03a25c09d055c60694ebd4ecd2","rgb24_sha256":"ddd2e59b0774d836f4664fc570100e26919f96b634f9bc0dff4dcdc90c4b85d9"}},{"family":"classification-operation","domain":"vigi.recording-search.request-relative.classification-operation.v1","expected_id":"rr-classification-operation-v1-084fca60c1c68f60ec42c584fb9cdc5222e06a599671bf6cf3c249b74a68d778","payload":{"investigation_id":"inv-01","run_id":"run-01","frame_id":"rr-frame-v1-49b75b91470d3a5e92a8e258c8743a6efa5b119ec8d9fec5dea3f3faae7a53fa","target_request_id":"rr-target-request-v1-f5086a246443b925a8e316f94ff4ebdf51f5938d067da97c0bf98d9c8d753e0d","baseline_identity":"baseline-v3-01","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","attempt":1,"result_kind":"VISUAL","outcome":"PRESENT","reason_code":null,"classifier_evidence":{"baseline_mask_pixel_count":256,"probe_mask_pixel_count":240,"roi_pixel_count":1024,"mask_intersection_pixel_count":220,"mask_union_pixel_count":276,"baseline_mask_coverage":"0.250000","probe_mask_coverage":"0.234375","mask_iou":"0.797101","effective_comparison_area":220,"roi_luma_ncc":"0.850000","visual_status":"comparable","unusable_reason":null},"operational_reason":null}},{"family":"classification-operation","domain":"vigi.recording-search.request-relative.classification-operation.v1","expected_id":"rr-classification-operation-v1-c0911e3562c26ffee11d8c02359316eb267f8c17439e67c04f32c727e06ef609","payload":{"investigation_id":"inv-01","run_id":"run-01","frame_id":"rr-frame-v1-d7ce40102428c857bff432fca759fad369ef8d8b01cfbb3db3135a432362b160","target_request_id":"rr-target-request-v1-b501e0aa7edbe22730d48dbfd1f15106373ef1ea74bd90cbf99cf491156fbfd1","baseline_identity":"baseline-v3-01","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","attempt":1,"result_kind":"VISUAL","outcome":"ABSENT","reason_code":null,"classifier_evidence":{"baseline_mask_pixel_count":640,"probe_mask_pixel_count":64,"roi_pixel_count":1024,"mask_intersection_pixel_count":64,"mask_union_pixel_count":640,"baseline_mask_coverage":"0.625000","probe_mask_coverage":"0.062500","mask_iou":"0.100000","effective_comparison_area":64,"roi_luma_ncc":"0.200000","visual_status":"comparable","unusable_reason":null},"operational_reason":null}},{"family":"classification-operation","domain":"vigi.recording-search.request-relative.classification-operation.v1","expected_id":"rr-classification-operation-v1-252a542e91d1effa800a913b311f0a8bf01294df5050aa2e93a8f3067bda4d69","payload":{"investigation_id":"inv-01","run_id":"run-01","frame_id":"rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","target_request_id":"rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","baseline_identity":"baseline-v3-01","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","attempt":1,"result_kind":"VISUAL","outcome":"ABSENT","reason_code":null,"classifier_evidence":{"baseline_mask_pixel_count":640,"probe_mask_pixel_count":64,"roi_pixel_count":1024,"mask_intersection_pixel_count":64,"mask_union_pixel_count":640,"baseline_mask_coverage":"0.625000","probe_mask_coverage":"0.062500","mask_iou":"0.100000","effective_comparison_area":64,"roi_luma_ncc":"0.200000","visual_status":"comparable","unusable_reason":null},"operational_reason":null}},{"family":"observation","domain":"vigi.recording-search.request-relative.observation.v1","expected_id":"rr-observation-v1-0d6159114041864969162f08952cc1bb8254bcdccf01f71cea76927c52218c5f","payload":{"investigation_id":"inv-01","run_id":"run-01","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","classification_operation_id":"rr-classification-operation-v1-084fca60c1c68f60ec42c584fb9cdc5222e06a599671bf6cf3c249b74a68d778","frame_id":"rr-frame-v1-49b75b91470d3a5e92a8e258c8743a6efa5b119ec8d9fec5dea3f3faae7a53fa","target_request_id":"rr-target-request-v1-f5086a246443b925a8e316f94ff4ebdf51f5938d067da97c0bf98d9c8d753e0d","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","outcome":"PRESENT","reason_code":null,"classifier_evidence":{"baseline_mask_pixel_count":256,"probe_mask_pixel_count":240,"roi_pixel_count":1024,"mask_intersection_pixel_count":220,"mask_union_pixel_count":276,"baseline_mask_coverage":"0.250000","probe_mask_coverage":"0.234375","mask_iou":"0.797101","effective_comparison_area":220,"roi_luma_ncc":"0.850000","visual_status":"comparable","unusable_reason":null}}},{"family":"observation","domain":"vigi.recording-search.request-relative.observation.v1","expected_id":"rr-observation-v1-63a3d24c0565cc60b5796591a5c8462d9789258dd5027310acf2b85ac0671739","payload":{"investigation_id":"inv-01","run_id":"run-01","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","classification_operation_id":"rr-classification-operation-v1-c0911e3562c26ffee11d8c02359316eb267f8c17439e67c04f32c727e06ef609","frame_id":"rr-frame-v1-d7ce40102428c857bff432fca759fad369ef8d8b01cfbb3db3135a432362b160","target_request_id":"rr-target-request-v1-b501e0aa7edbe22730d48dbfd1f15106373ef1ea74bd90cbf99cf491156fbfd1","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","outcome":"ABSENT","reason_code":null,"classifier_evidence":{"baseline_mask_pixel_count":640,"probe_mask_pixel_count":64,"roi_pixel_count":1024,"mask_intersection_pixel_count":64,"mask_union_pixel_count":640,"baseline_mask_coverage":"0.625000","probe_mask_coverage":"0.062500","mask_iou":"0.100000","effective_comparison_area":64,"roi_luma_ncc":"0.200000","visual_status":"comparable","unusable_reason":null}}},{"family":"observation","domain":"vigi.recording-search.request-relative.observation.v1","expected_id":"rr-observation-v1-dc4c6b50adf0d8099becbb5ec2d32abaffe4f14e9d6b499b607c3b73134e5a33","payload":{"investigation_id":"inv-01","run_id":"run-01","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","classification_operation_id":"rr-classification-operation-v1-252a542e91d1effa800a913b311f0a8bf01294df5050aa2e93a8f3067bda4d69","frame_id":"rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","target_request_id":"rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","outcome":"ABSENT","reason_code":null,"classifier_evidence":{"baseline_mask_pixel_count":640,"probe_mask_pixel_count":64,"roi_pixel_count":1024,"mask_intersection_pixel_count":64,"mask_union_pixel_count":640,"baseline_mask_coverage":"0.625000","probe_mask_coverage":"0.062500","mask_iou":"0.100000","effective_comparison_area":64,"roi_luma_ncc":"0.200000","visual_status":"comparable","unusable_reason":null}}},{"family":"classification-operation","domain":"vigi.recording-search.request-relative.classification-operation.v1","expected_id":"rr-classification-operation-v1-334d12afe5b403ea8f78626af1b4e5890bf7172749d5bc769822142c5ff01005","payload":{"investigation_id":"inv-01","run_id":"run-01","frame_id":"rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","target_request_id":"rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","baseline_identity":"baseline-v3-01","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","attempt":1,"result_kind":"VISUAL","outcome":"INDETERMINATE","reason_code":"insufficient_visual_evidence","classifier_evidence":{"baseline_mask_pixel_count":256,"probe_mask_pixel_count":180,"roi_pixel_count":1024,"mask_intersection_pixel_count":90,"mask_union_pixel_count":346,"baseline_mask_coverage":"0.250000","probe_mask_coverage":"0.175781","mask_iou":"0.260116","effective_comparison_area":90,"roi_luma_ncc":"0.400000","visual_status":"comparable","unusable_reason":null},"operational_reason":null}},{"family":"observation","domain":"vigi.recording-search.request-relative.observation.v1","expected_id":"rr-observation-v1-22fd93b8d37f3b6643dc14549d6e003b7439d618752c7bd9cbf43e3ddf7f7c73","payload":{"investigation_id":"inv-01","run_id":"run-01","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","classification_operation_id":"rr-classification-operation-v1-334d12afe5b403ea8f78626af1b4e5890bf7172749d5bc769822142c5ff01005","frame_id":"rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","target_request_id":"rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","outcome":"INDETERMINATE","reason_code":"insufficient_visual_evidence","classifier_evidence":{"baseline_mask_pixel_count":256,"probe_mask_pixel_count":180,"roi_pixel_count":1024,"mask_intersection_pixel_count":90,"mask_union_pixel_count":346,"baseline_mask_coverage":"0.250000","probe_mask_coverage":"0.175781","mask_iou":"0.260116","effective_comparison_area":90,"roi_luma_ncc":"0.400000","visual_status":"comparable","unusable_reason":null}}},{"family":"classification-operation","domain":"vigi.recording-search.request-relative.classification-operation.v1","expected_id":"rr-classification-operation-v1-a589ab6c39eb68d580cae50894a0d4f1fb1005167a0bf805f78b8807ab6c9cb9","payload":{"investigation_id":"inv-01","run_id":"run-01","frame_id":"rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","target_request_id":"rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","baseline_identity":"baseline-v3-01","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","attempt":1,"result_kind":"OPERATIONAL","outcome":null,"reason_code":null,"classifier_evidence":null,"operational_reason":"classifier_timeout"}},{"family":"classification-operation","domain":"vigi.recording-search.request-relative.classification-operation.v1","expected_id":"rr-classification-operation-v1-579c826837810484e93f5c3a3e2f489b127e366f6f729be552e1e43c21199367","payload":{"investigation_id":"inv-01","run_id":"run-01","frame_id":"rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","target_request_id":"rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","baseline_identity":"baseline-v3-01","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","attempt":1,"result_kind":"OPERATIONAL","outcome":null,"reason_code":null,"classifier_evidence":null,"operational_reason":"classification_failed"}},{"family":"classification-operation","domain":"vigi.recording-search.request-relative.classification-operation.v1","expected_id":"rr-classification-operation-v1-6bb3059ec96d8ba34cec97e200f0ced449acba037a360ae9dff7df4bf957832a","payload":{"investigation_id":"inv-01","run_id":"run-01","frame_id":"rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539","target_request_id":"rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695","baseline_identity":"baseline-v3-01","classifier_policy_id":"rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f","attempt":1,"result_kind":"OPERATIONAL","outcome":null,"reason_code":null,"classifier_evidence":null,"operational_reason":"invalid_classifier_result"}},{"family":"phase8-manifest","domain":"vigi.recording-search.request-relative.phase8-manifest.v1","expected_id":"rr-phase8-manifest-v1-30a8bfb6bd04e25014be746aa4b968b1efaffeaf964b0ba11361c502d1c020c8","payload":{"schema_version":1,"state":"RETRYABLE","investigation_id":"inv-01","run_id":"run-01","terminal_result_id":"rr-terminal-result-v1-5e60d22bb0917bc5303962cf5d80c12deffd7adc3e37e50e9edc95adef921cff","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","previous_phase8_manifest_id":null,"source_clip_id":null,"clip_integrity":null,"phase8_request_id":null,"failure_reason":"phase8_clip_failed"}},{"family":"phase8-manifest","domain":"vigi.recording-search.request-relative.phase8-manifest.v1","expected_id":"rr-phase8-manifest-v1-a55b32f217d0fc677a30f6146c987c69fe4a88b6c3f34fa72c237881859e4631","payload":{"schema_version":1,"state":"RETRYABLE","investigation_id":"inv-01","run_id":"run-01","terminal_result_id":"rr-terminal-result-v1-5e60d22bb0917bc5303962cf5d80c12deffd7adc3e37e50e9edc95adef921cff","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","previous_phase8_manifest_id":"rr-phase8-manifest-v1-a2448760860a38d3873fa63ab3cd302b79741a878698bba875ef31c0c94e63da","source_clip_id":"rr-source-clip-v1-2334094f9d46b889e8b826d668659456d57c028feca87e58cf1e91a0388de503","clip_integrity":{"sha256":"9e23896ae9d7d66b3473be0da74cf92f51752af0d1a7873f5921a7a4f712ceb3","size_bytes":2430,"observed_duration_ticks":65536,"observed_time_base_num":1,"observed_time_base_den":16384,"video_stream_index":0,"codec":"h264","profile":"High","level":41,"pixel_format":"yuv420p","width":32,"height":32,"average_frame_rate_num":1,"average_frame_rate_den":1,"audio_stream_count":0,"generation_outcome":"REENCODED"},"phase8_request_id":"rr-phase8-request-v1-41e93ebd33d7a546dad57f180f9467977b6345b143b343e32b3f76fee37366f9","failure_reason":"phase8_media_corrupt"}},{"family":"phase8-manifest","domain":"vigi.recording-search.request-relative.phase8-manifest.v1","expected_id":"rr-phase8-manifest-v1-2130eef454647893f9203ded38e56058b6e81c60a7846ed1c33ba8e7dce2b66f","payload":{"schema_version":1,"state":"CLIP_READY","investigation_id":"inv-01","run_id":"run-01","terminal_result_id":"rr-terminal-result-v1-5e60d22bb0917bc5303962cf5d80c12deffd7adc3e37e50e9edc95adef921cff","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","previous_phase8_manifest_id":null,"source_clip_id":"rr-source-clip-v1-2334094f9d46b889e8b826d668659456d57c028feca87e58cf1e91a0388de503","clip_integrity":{"sha256":"9e23896ae9d7d66b3473be0da74cf92f51752af0d1a7873f5921a7a4f712ceb3","size_bytes":2430,"observed_duration_ticks":65536,"observed_time_base_num":1,"observed_time_base_den":16384,"video_stream_index":0,"codec":"h264","profile":"High","level":41,"pixel_format":"yuv420p","width":32,"height":32,"average_frame_rate_num":1,"average_frame_rate_den":1,"audio_stream_count":0,"generation_outcome":"REENCODED"}}},{"family":"phase8-manifest","domain":"vigi.recording-search.request-relative.phase8-manifest.v1","expected_id":"rr-phase8-manifest-v1-08de03a1867861815ffad2c80cdde46d809a48d2bfae2fc9c48533eebf853065","payload":{"schema_version":1,"state":"DELETING","investigation_id":"inv-01","run_id":"run-01","terminal_result_id":"rr-terminal-result-v1-5e60d22bb0917bc5303962cf5d80c12deffd7adc3e37e50e9edc95adef921cff","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","previous_phase8_manifest_id":"rr-phase8-manifest-v1-a2448760860a38d3873fa63ab3cd302b79741a878698bba875ef31c0c94e63da","source_clip_id":"rr-source-clip-v1-2334094f9d46b889e8b826d668659456d57c028feca87e58cf1e91a0388de503","clip_integrity":{"sha256":"9e23896ae9d7d66b3473be0da74cf92f51752af0d1a7873f5921a7a4f712ceb3","size_bytes":2430,"observed_duration_ticks":65536,"observed_time_base_num":1,"observed_time_base_den":16384,"video_stream_index":0,"codec":"h264","profile":"High","level":41,"pixel_format":"yuv420p","width":32,"height":32,"average_frame_rate_num":1,"average_frame_rate_den":1,"audio_stream_count":0,"generation_outcome":"REENCODED"},"phase8_request_id":"rr-phase8-request-v1-41e93ebd33d7a546dad57f180f9467977b6345b143b343e32b3f76fee37366f9","common_media_tombstone_name":".delete-rr-common-session-v1-f591f022302f4296debe0a5a5480e39e138f83246dfac1322d37a53ecc1afb68.mp4","source_clip_tombstone_name":".delete-9e23896ae9d7d66b3473be0da74cf92f51752af0d1a7873f5921a7a4f712ceb3.mp4"}},{"family":"phase8-manifest","domain":"vigi.recording-search.request-relative.phase8-manifest.v1","expected_id":"rr-phase8-manifest-v1-2ff0c5c45a51a96bd376492712272620437a9f8a99e5b2ee5073b30cac2eb6d8","payload":{"schema_version":1,"state":"DELETED","investigation_id":"inv-01","run_id":"run-01","terminal_result_id":"rr-terminal-result-v1-5e60d22bb0917bc5303962cf5d80c12deffd7adc3e37e50e9edc95adef921cff","common_session_id":"rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9","previous_phase8_manifest_id":"rr-phase8-manifest-v1-08de03a1867861815ffad2c80cdde46d809a48d2bfae2fc9c48533eebf853065","source_clip_id":"rr-source-clip-v1-2334094f9d46b889e8b826d668659456d57c028feca87e58cf1e91a0388de503","clip_integrity":{"sha256":"9e23896ae9d7d66b3473be0da74cf92f51752af0d1a7873f5921a7a4f712ceb3","size_bytes":2430,"observed_duration_ticks":65536,"observed_time_base_num":1,"observed_time_base_den":16384,"video_stream_index":0,"codec":"h264","profile":"High","level":41,"pixel_format":"yuv420p","width":32,"height":32,"average_frame_rate_num":1,"average_frame_rate_den":1,"audio_stream_count":0,"generation_outcome":"REENCODED"},"phase8_request_id":"rr-phase8-request-v1-41e93ebd33d7a546dad57f180f9467977b6345b143b343e32b3f76fee37366f9","common_media_tombstone_name":".delete-rr-common-session-v1-f591f022302f4296debe0a5a5480e39e138f83246dfac1322d37a53ecc1afb68.mp4","source_clip_tombstone_name":".delete-9e23896ae9d7d66b3473be0da74cf92f51752af0d1a7873f5921a7a4f712ceb3.mp4","deletion_result":"DELETED"}}]
```
...
[
  {
    ...
    "expected_id": "rr-classification-operation-v1-cae37b8018ccef0bec8023b0b789f6da52d2f11fc51de8715ea9a4f5d5485f31",
    "payload": {
      "investigation_id": "inv-01",
      "run_id": "run-01",
      "frame_id": "rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539",
      "target_request_id": "rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695",
      "baseline_identity": "baseline-v3-01",
      "classifier_policy_id": "rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f",
      "attempt": 1,
      "result_kind": "VISUAL",
  ...
  },
  {
    ...
    "expected_id": "rr-observation-v1-493f2a8841f2dfc2e53b5468799b4e32c8bc73663285534d79729599eb568cd0",
    "payload": {
      "investigation_id": "inv-01",
      "run_id": "run-01",
      "common_session_id": "rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9",
      "classification_operation_id": "rr-classification-operation-v1-cae37b8018ccef0bec8023b0b789f6da52d2f11fc51de8715ea9a4f5d5485f31",
      "frame_id": "rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539",
      "target_request_id": "rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695",
      "classifier_policy_id": "rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f",
      "outcome": "INDETERMINATE",
  ...
  },
  {
    "family": "classification-operation",
    "domain": "vigi.recording-search.request-relative.classification-operation.v1",
    "expected_id": "rr-classification-operation-v1-dbb39104452ba80c2cbb2a85adb6bb2e01c72c73eea1f8982bb4e62f5fd8d730",
    "payload": {
      "investigation_id": "inv-01",
      "run_id": "run-01",
      "frame_id": "rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539",
  ...
  },
  {
    "family": "observation",
    "domain": "vigi.recording-search.request-relative.observation.v1",
    "expected_id": "rr-observation-v1-a561edc719ff808d0bf51dda4e8e1525690e01f6678d844403c03b8d009860f7",
    "payload": {
      "investigation_id": "inv-01",
      "run_id": "run-01",
      "common_session_id": "rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9",
      "classification_operation_id": "rr-classification-operation-v1-dbb39104452ba80c2cbb2a85adb6bb2e01c72c73eea1f8982bb4e62f5fd8d730",
      "frame_id": "rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539",
      "target_request_id": "rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695",
      "classifier_policy_id": "rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f",
      "outcome": "INDETERMINATE",
  ...
  },
  {
    "family": "classification-operation",
    "domain": "vigi.recording-search.request-relative.classification-operation.v1",
    "expected_id": "rr-classification-operation-v1-4a22f59baf1a11557129b408993c65871bceb8fc9ea953026e318da45c61181d",
    "payload": {
      "investigation_id": "inv-01",
      "run_id": "run-01",
      "frame_id": "rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539",
  ...
  },
  {
    "family": "observation",
    "domain": "vigi.recording-search.request-relative.observation.v1",
    "expected_id": "rr-observation-v1-faa482d4277b27a2f363b407aad80428b521725ac9b7639635cfbf7a6b15252e",
    "payload": {
      "investigation_id": "inv-01",
      "run_id": "run-01",
      "common_session_id": "rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9",
      "classification_operation_id": "rr-classification-operation-v1-4a22f59baf1a11557129b408993c65871bceb8fc9ea953026e318da45c61181d",
      "frame_id": "rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539",
      "target_request_id": "rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695",
      "classifier_policy_id": "rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f",
      "outcome": "INDETERMINATE",
  ...
  },
  {
    "family": "classification-operation",
    "domain": "vigi.recording-search.request-relative.classification-operation.v1",
    "expected_id": "rr-classification-operation-v1-1ba05c94be7e2b88aaad2d5e53da0b39ab48500393053f664000aa1a1b48092e",
    "payload": {
      "investigation_id": "inv-01",
      "run_id": "run-01",
      "frame_id": "rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539",
  ...
  },
  {
    "family": "observation",
    "domain": "vigi.recording-search.request-relative.observation.v1",
    "expected_id": "rr-observation-v1-61f7a42a46b4995c29f6d0ac617e72bc76695060baaa12911bcac93222cc6e45",
    "payload": {
      "investigation_id": "inv-01",
      "run_id": "run-01",
      "common_session_id": "rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9",
      "classification_operation_id": "rr-classification-operation-v1-1ba05c94be7e2b88aaad2d5e53da0b39ab48500393053f664000aa1a1b48092e",
      "frame_id": "rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539",
      "target_request_id": "rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695",
      "classifier_policy_id": "rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f",
      "outcome": "INDETERMINATE",
  ...
  },
  {
    "family": "classification-operation",
    "domain": "vigi.recording-search.request-relative.classification-operation.v1",
    "expected_id": "rr-classification-operation-v1-52bc8a10326b4c5bd3bdc73fae0ced8c9be1871fb5365aa0c2552e9bc8348b7d",
    "payload": {
      "investigation_id": "inv-01",
      "run_id": "run-01",
      "frame_id": "rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539",
  ...
  },
  {
    "family": "observation",
    "domain": "vigi.recording-search.request-relative.observation.v1",
    "expected_id": "rr-observation-v1-c7bfb7cbd55c0c22a06b05733ae9c0c0cab35f3fd17bb64457d836610f3acb97",
    "payload": {
      "investigation_id": "inv-01",
      "run_id": "run-01",
      "common_session_id": "rr-common-session-v1-38df353ce1256fe21f26ae7f77f666251d939dd663d1aca12b7fa26b2a8d6af9",
      "classification_operation_id": "rr-classification-operation-v1-52bc8a10326b4c5bd3bdc73fae0ced8c9be1871fb5365aa0c2552e9bc8348b7d",
      "frame_id": "rr-frame-v1-912e84c7edc205d0c3957badd78a47cbad10f3dc7fbf450af4d8e2bf1a369539",
      "target_request_id": "rr-target-request-v1-b137489a22ba15797e66952d0dbbafd6c2ed287aa2922846648f08297a606695",
      "classifier_policy_id": "rr-classifier-policy-v1-d20a9d64543ce5bfa2b0d4861952593d36342ad51489588de06c89efa258838f",
      "outcome": "INDETERMINATE",
...
The retained-media boundary keeps the public reason codes unchanged and emits
one version-1, process-local `phase7e.media_probe_failure` warning while the
invocation-owned temporary MP4 still exists, before cleanup. It then finalizes
the correlated in-process diagnostic with the cleanup outcome. The existing
bounded browser worker ledger may retain that typed diagnostic while the run
remains in process;
...
`32`. The classifier has a 30-second per-call ceiling and a 320-second total
